...
| | **3** | Model Training | `train_models.py`<br>**Run:** `python3 train_models.py` | **Files:** `models/champion_model.pkl`, `models/feature_scaler.pkl`<br>**Outcome:** 5 model families trained on Pre-2021 data (Validation 21-22) with standard hyperparameter grid. |
