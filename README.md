...
| | **8** | Performance Optimization (HPC) | `finmc_tech/simulation/numpy_mc_demo.py`<br>**Run:** `python3 -m finmc_tech.simulation.numpy_mc_demo`<br><br>`finmc_tech/simulation/numba_mc_demo.py`<br>**Run:** `python3 -m finmc_tech.simulation.numba_mc_demo`<br><br>`finmc_tech/hpc_demos/mpi_mc_demo.py`<br>**Run:** `mpirun -n 4 python3 -m finmc_tech.hpc_demos.mpi_mc_demo`<br><br>`finmc_tech/hpc_demos/openmp_mc_demo.c`<br>**Run:** `gcc -O3 -fopenmp finmc_tech/hpc_demos/openmp_mc_demo.c -o openmp_mc_demo && ./openmp_mc_demo`<br><br>`plot_hpc_benchmark_comparison.py`<br>**Run:** `python3 plot_hpc_benchmark_comparison.py` | Scaling Curve (`results/step8/hpc_benchmark_comparison_all.png`)<br>Benchmark Data (`hpc_benchmark.csv`) |
